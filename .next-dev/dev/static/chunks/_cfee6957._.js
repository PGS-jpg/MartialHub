...
function UserProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            ...
            const onStorage = {
                "UserProvider.useEffect.onStorage": (event)=>{
            ...
            }["UserProvider.useEffect.onStorage"];
            window.addEventListener("storage", onStorage);
            return ({
                "UserProvider.useEffect": ()=>window.removeEventListener("storage", onStorage)
            })["UserProvider.useEffect"];
        }
    }["UserProvider.useEffect"], [
        isAuthReady
...
_s(UserProvider, "sCcX3ErsusmrlDZdFXSyG/43YB8=", false, function() {
    return [
...
"[project]/components/pwa-register.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PwaRegister() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PwaRegister.useEffect": ()=>{
            ...
            const register = {
                "PwaRegister.useEffect.register": async ()=>{
                    try {
            ...
            }["PwaRegister.useEffect.register"];
            void register();
        }
    }["PwaRegister.useEffect"], []);
    return null;
...
//# sourceMappingURL=_cfee6957._.js.map