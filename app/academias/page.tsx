...
import { LocateFixed, ShieldCheck, Users } from "lucide-react"
...
import { AcademyList } from "@/components/selestialhub/academy-list"
          ...
          <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#17181b] via-[#111216] to-[#0f1013] p-6 shadow-[0_20px_70px_rgba(0,0,0,0.4)] lg:p-8">
            ...
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl">
                <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-[#ff5b00]">Rede de academias</p>
                <h1 className="mt-3 font-sans text-3xl font-black uppercase tracking-tight text-white lg:text-5xl">
                  Encontre sua próxima base
                </h1>
                <p className="mt-3 max-w-xl text-sm text-white/65 lg:text-base">
                  Descubra academias por modalidade, localização e nível mínimo, com mapa, contato direto e cadastro premium para equipes.
                </p>
              </div>
